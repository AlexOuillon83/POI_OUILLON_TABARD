    ...
    public class SeedData
    {
        ...
        public List<PointInteret> getListePointInterets()
        {
            ...
            while (csv.Read())
            {
                ...
                string nomCategorie = csv.GetField<string>(1);
                // Récupère le texte de l'adresse
                string texte = csv.GetField<string>(2);
                // Récupère le ZipCode
                string zipCode = csv.GetField<string>(3);
                // Récupère la longitude
                string longitude = csv.GetField<string>(4);
                // Récupère la latitude
                string latitude = csv.GetField<string>(5);
                // Récupère la commune
                string nomCommune = csv.GetField<string>(6);
                ...
                _logger.LogWarning(String.Format("PoI: {0}", pointInteret == null));
